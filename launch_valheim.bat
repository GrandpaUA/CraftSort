@echo off
REM Launch Valheim with BepInEx via Doorstop — replicates r2modman "Gun world" profile launch
...
set "PROFILE_DIR=%APPDATA%\r2modmanPlus-local\Valheim\profiles\Gun world"
...
echo Starting Valheim via Steam with BepInEx (Gun world profile)...
